...
namespace VXI_GAMS_US.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            return RedirectToActionPermanent("Administrator");
        }
        ...
        {
            var FileName = await ExcelHelper.ToExcelAsync(ConfigurationManager.ConnectionStrings["DefaultConnection"].ToString(), parameters);
        ...
        [DeleteFileAttribute]
        public async Task<FileResult> GetReport(string f, string t, string l)
        {
            var today = DateTimeHelper.GetDate;
            var time = today.TimeOfDay;
            var tmpFile = $"REPORT-{today:MM.dd.yyyy_HH.mm.ss.fff_tt}.xlsx";
            return await CreateResult(tmpFile, new SqlParameter("REPORT", Query.GetReport(f, t, l)));
        }
